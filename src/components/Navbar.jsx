...
const Navbar = () => {
  ...
  const getNavActive = ({ isActive }) => {
    ...
    const navLinkActive = "text-green-700 text-[18px] font-semibold";
          ...
          <div className="navbar-start">
            <Link to="/">
              <div className="flex justify-center items-center hover:scale-105">
                ...
                <p className="btn border-none p-1 text-[24px] md:text-[28px]  bg-linear-to-r from-[#4feb59] to-[#315805] bg-clip-text text-transparent">
                  PlateShare
                </p>
              </div>
            </Link>
          ...
          <div className="navbar-end gap-3">
            { user ? (
              <div className="navbar-end  hidden lg:flex">
                <div className="dropdown dropdown-end">
                  ...
                  <ul tabIndex="-1" className="menu menu-sm dropdown-content bg-[#eef5ed]  items-start rounded-box z-1 my-2 w-60 p-2 ">
                    <li>  <NavLink to="/" className={getNavActive}> Profile  </NavLink>  </li>
            ...
            <div className="dropdown dropdown-end">
              ...
              </div>
              {
                user ? (
                  <ul tabIndex="-1"  className="menu menu-sm dropdown-content bg-[#eef5ed]  items-start rounded-box z-1 my-2 w-60 p-2 ">
                <li>  <NavLink to="/profile" className={getNavActive}>  Profile  </NavLink>  </li>
                <li> <NavLink to="/" className={getNavActive}> Home  </NavLink> </li>
                <li>  <NavLink to="/available-foods" className={getNavActive}>  Foods </NavLink> </li>
                <li> <NavLink to="/create-food" className={getNavActive}>  Add Food </NavLink> </li>
                <li> <NavLink to="/manage-food" className={getNavActive}>  Manage My Foods </NavLink>  </li>
